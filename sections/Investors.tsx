...
export default function Investors(
  ...
  return (
    <div class={"bg-gray-800 py-[6.6vmax] px-[4vw] mb-8 mx-auto"}>
      <div class={"flex flex-col"}>
        ...
        <p
          class={"leading-7 font-medium my-4 text-base text-white font-poppins mb-[6.6vmax]"}
        >
          {footerText}
        </p>

        <button
          class={`lg:w-[477px] lg:h-[108px] max-w-[calc(100% - 50px)] md:max-w-full md:w-[300px] md:h-[80px] w-full h-16 flex justify-center items-center bg-orange-200 hover:opacity-80 transition mt-[16vh] md:mt-[6.6vmax] mx-auto`}
        >
          <a
